...
const DROP_IN_PROGRAMS = new Set(["rooted_focus"]);
...
/** Rooted Focus displays as a Productivity Session regardless of the stored
    category (older rows were created as "Business"/"Networking"). */
